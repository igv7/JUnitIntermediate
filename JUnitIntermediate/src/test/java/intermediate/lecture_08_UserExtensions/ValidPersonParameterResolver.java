...
class ValidPersonParameterResolver implements ParameterResolver {
	
	public static final Person[] VALID_PERSONS = {
			new Person().setId(1L).setFirstName("Moshe").setLastName("Moshe"),
			new Person().setId(2L).setFirstName("Kobi").setLastName("Kobi"),
			new Person().setId(3L).setFirstName("Igor").setLastName("Igor"),
			new Person().setId(4L).setFirstName("Matan").setLastName("Matan"),
			new Person().setId(5L).setFirstName("Zamir").setLastName("Zamir"),
